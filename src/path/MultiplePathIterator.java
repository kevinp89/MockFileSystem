...
public class MultiplePathIterator implements PathIterate, Iterator<ConcretePath> {

  private TreeMap<Integer, ConcretePath> path;
  private Iterator<Integer> iter;
  public MultiplePathIterator(TreeMap<Integer, ConcretePath> p){
    path = p;
    iter = p.navigableKeySet().iterator();
