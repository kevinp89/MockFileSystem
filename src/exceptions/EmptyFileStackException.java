...
/**
 * Will handle  the error when the user tries to pop a file on an empty stack
 */

public class EmptyFileStackException extends Exception{

    public EmptyFileStackException() {super("The FileStack is empty");}

    public EmptyFileStackException(String msg) {super(msg);}
}
